...
Built RESTful API endpoints for managing cars, reservations, and users

Designed responsive UI with React, integrating dynamic components and state management

Used MongoDB to store and manage rental data efficiently

Ensured full-stack communication between frontend and backend through structured API routes
